if not clonefunction or not setreadonly or not gethui or newcclosure or not cloneref or not getgenv or not getrenv then
    return error'missing depdencies to use drawing lib.'
end
...
if not game:GetService('Players').LocalPlayer then
    while task.wait() do
		if game:GetService('Players').LocalPlayer then break
		end
	end;
end
...
local isrenderobj = newcclosure(function(x)
	return tostring(x) == "Drawing";
end);

genv.isrenderobj = isrenderobj
